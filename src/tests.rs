...
//         // Check that the entropy was saved correctly
//         // let entropy_key = ENTROPY.load(&deps.storage).unwrap();
//         // assert_eq!(entropy_key.entropy, entropy);
    
//         // Check that the callback message was saved correctly
//         // let callback_key = CALLBACK_MSG.load(&deps.storage).unwrap();
//         // assert_eq!(callback_key.requester, requester);
//         // assert_eq!(callback_key.msg, msg);
