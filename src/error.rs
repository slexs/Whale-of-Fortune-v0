...
pub enum ContractError {
    ...
    #[error("Unauthorized, {addr} is not the admin")]
    UnauthorizedNotAdmin { addr: String },
    ...
    #[error(
        "Bet amount mismatch, player sent amount: {player_sent_amount}, bet amount: {bet_amount}"
    )]
